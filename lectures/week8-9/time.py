...
# start_time = pygame.time.get_ticks()  # Засекаем время старта

# running = True
# while running:
#     screen.fill((255, 255, 255))
    
#     elapsed_time = (pygame.time.get_ticks() - start_time) // 1000  # Сколько секунд прошло
#     text = font.render(f"Время: {elapsed_time} сек.", True, (0, 0, 0))
#     screen.blit(text, (20, 20))  # Отображение таймера
...
while True:
    ...
    if not snake.alive:
        game_over_text = game_over_font.render("Game Over - Press R to Restart", True, (255, 0, 0))
